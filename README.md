...
Реализована инициализация абстрактного класса BaseProduct, от которого наследуются Product.
Методы BaseProduct:
1. Создание товара
2. Указание цены товара

Реализован класс-миксин для логирования создания экземпляров класса в консоль
Метод логирования:
1. Логирование создания экземпляра класса
